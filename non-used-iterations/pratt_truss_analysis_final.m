...
height = linspace(l/12, l/9,500); % height in m
...
for i = 1:1:loop_length
    ...
    for j = 1:1:(n-1)/2
        ...
        A_name = string(char(64+2*i))+string(char(67+2*i));
        B_name = string(char(65+2*i))+string(char(67+2*i));
        C_name = string(char(64+2*i))+string(char(66+2*i));
        D_name = string(char(64+2*i))+string(char(65+2*i));
